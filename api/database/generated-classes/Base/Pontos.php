...
/**
 * Base class that represents a row from the 'pontos' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Pontos implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PontosTableMap';
    ...
    /**
     * Initializes internal state of Base\Pontos object.
     */
    ...
    /**
     * Compares this with another <code>Pontos</code> instance.  If
     * <code>obj</code> is an instance of <code>Pontos</code>, delegates to
     * <code>equals(Pontos)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Pontos The current object, for fluid interface
     */
     ...
     * @return $this|\Pontos The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PontosTableMap::COL_ID] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[PontosTableMap::COL_NOME] = true;
        }
    ...
    public function setIp($v)
    {
        ...
        if ($this->ip !== $v) {
            $this->ip = $v;
            $this->modifiedColumns[PontosTableMap::COL_IP] = true;
        }
    ...
    public function setCreatedat($v)
    {
        ...
        if ($this->createdat !== null || $dt !== null) {
            if ($this->createdat === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createdat->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PontosTableMap::COL_CREATEDAT] = true;
            }
    ...
    public function setUpdatedat($v)
    {
        ...
        if ($this->updatedat !== null || $dt !== null) {
            if ($this->updatedat === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updatedat->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PontosTableMap::COL_UPDATEDAT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PontosTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PontosTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nome = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PontosTableMap::translateFieldName('Ip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PontosTableMap::translateFieldName('Createdat', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createdat = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PontosTableMap::translateFieldName('Updatedat', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = PontosTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Pontos'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPontosQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Pontos::setDeleted()
     * @see Pontos::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPontosQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PontosTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PontosTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PontosTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PontosTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PontosTableMap::COL_NOME)) {
            $modifiedColumns[':p' . $index++]  = 'nome';
        }
        if ($this->isColumnModified(PontosTableMap::COL_IP)) {
            $modifiedColumns[':p' . $index++]  = 'ip';
        }
        if ($this->isColumnModified(PontosTableMap::COL_CREATEDAT)) {
            $modifiedColumns[':p' . $index++]  = 'createdAt';
        }
        if ($this->isColumnModified(PontosTableMap::COL_UPDATEDAT)) {
    ...
    {
        $pos = PontosTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Pontos'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Pontos'][$this->hashCode()] = true;
        $keys = PontosTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNome(),
            $keys[2] => $this->getIp(),
    ...
    {
        $criteria = new Criteria(PontosTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PontosTableMap::COL_ID)) {
            $criteria->add(PontosTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PontosTableMap::COL_NOME)) {
            $criteria->add(PontosTableMap::COL_NOME, $this->nome);
        }
        if ($this->isColumnModified(PontosTableMap::COL_IP)) {
            $criteria->add(PontosTableMap::COL_IP, $this->ip);
        }
        if ($this->isColumnModified(PontosTableMap::COL_CREATEDAT)) {
            $criteria->add(PontosTableMap::COL_CREATEDAT, $this->createdat);
        }
        if ($this->isColumnModified(PontosTableMap::COL_UPDATEDAT)) {
            $criteria->add(PontosTableMap::COL_UPDATEDAT, $this->updatedat);
        }
    ...
    {
        $criteria = ChildPontosQuery::create();
        $criteria->add(PontosTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Pontos (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Pontos Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildPontos is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPontos The current object (for fluent API support)
     */
    public function setMarcacoess(Collection $marcacoess, ConnectionInterface $con = null)
    {
        ...
        foreach ($marcacoessToDelete as $marcacoesRemoved) {
            $marcacoesRemoved->setPontos(null);
        }
     ...
     * Otherwise if this Pontos is new, it will return
     * an empty collection; or if this Pontos has previously
     * been saved, it will retrieve related Marcacoess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Pontos.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildMarcacoes[] List of ChildMarcacoes objects
     */
    public function getMarcacoessJoinFuncionarios(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMarcacoesQuery::create(null, $criteria);
        $query->joinWith('Funcionarios', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(PontosTableMap::DEFAULT_STRING_FORMAT);
    }
