...
class FuncionariosTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Nome', 'Matricula', 'Pis', 'Createdat', 'Updatedat', ),
        self::TYPE_CAMELNAME     => array('id', 'nome', 'matricula', 'pis', 'createdat', 'updatedat', ),
        self::TYPE_COLNAME       => array(FuncionariosTableMap::COL_ID, FuncionariosTableMap::COL_NOME, FuncionariosTableMap::COL_MATRICULA, FuncionariosTableMap::COL_PIS, FuncionariosTableMap::COL_CREATEDAT, FuncionariosTableMap::COL_UPDATEDAT, ),
        self::TYPE_FIELDNAME     => array('id', 'nome', 'matricula', 'pis', 'createdAt', 'updatedAt', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Nome' => 1, 'Matricula' => 2, 'Pis' => 3, 'Createdat' => 4, 'Updatedat' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'nome' => 1, 'matricula' => 2, 'pis' => 3, 'createdat' => 4, 'updatedat' => 5, ),
        self::TYPE_COLNAME       => array(FuncionariosTableMap::COL_ID => 0, FuncionariosTableMap::COL_NOME => 1, FuncionariosTableMap::COL_MATRICULA => 2, FuncionariosTableMap::COL_PIS => 3, FuncionariosTableMap::COL_CREATEDAT => 4, FuncionariosTableMap::COL_UPDATEDAT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nome' => 1, 'matricula' => 2, 'pis' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
