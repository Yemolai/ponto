...
/**
 * This class defines the structure of the '_migrations' table.
 *
 *
 *
...
class MigrationsTableMap extends TableMap
{
     ...
     */
    const COL_NAME = '_migrations.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(MigrationsTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(MigrationsTableMap::COL_NAME => 0, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MigrationsTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MigrationsTableMap::COL_NAME, (array) $values, Criteria::IN);
        }
